...
class ScienceComplexLevel(GameLevel):
    ...
    def __add_items_to_level(self):
        ...
        _chart.common_items[3] = ('shotgun shell', 7)
        _chart.common_items[4] = ('medkit', 0)
        _chart.common_items[5] = ('amphetamine', 5)
        _chart.common_items[6] = ('combat boots', 0)
        _chart.common_items[7] = ('instant coffee', 0)
