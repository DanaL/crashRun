...
class ItemFactory:
    ...
    def __gen_item_db(self):
        ...
        self.__item_db['stylish leather jacket'] = ('armour','suit','brown','lightbrown',1,5,0,[])
        ...
        self.__item_db['long leather coat'] = ('armour','suit','brown','lightbrown',1,6,0,[('chutzpah',1,0)])
